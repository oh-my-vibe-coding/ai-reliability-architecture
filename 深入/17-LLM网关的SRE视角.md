...
> [← 返回目录](../README.md)  ·  对应知识章节：[第 5 章 · AI 推理服务的可靠性工程](../知识/05-AI推理服务的可靠性工程.md)、[第 8 章 · 质量可观测性 ＋ Data Flywheel](../知识/07-质量可观测性与DataFlywheel.md)
...
[第 8 章 · Data Flywheel](../知识/07-质量可观测性与DataFlywheel.md) 讲的飞轮起点是"用户反馈"。这是理想，**绝大多数团队拿不到密集、可靠的用户反馈**。
...
**与第 8 章那张"理想飞轮图"的关系**：网关版飞轮**不依赖用户主动反馈**，所以它跑得起来。是飞轮的"启动器"，不是替代品。等它跑起来积累了几个月数据，再叠加用户反馈、再叠加人工标注，就是第 8 章那张图。
