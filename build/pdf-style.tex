% ═══════════════════════════════════════════════════════════════════
% XeLaTeX preamble for《AI 时代的可靠性架构》PDF
...
\hypersetup{
  ...
  urlcolor={NavyBlue},
  citecolor={Maroon},
  pdftitle={AI 时代的可靠性架构},
  pdfauthor={SRE to AI SRE Learning Project},
  pdfsubject={写给 SRE 架构师的智能系统运维指南},
  bookmarksopen=false,
...
\pagestyle{fancy}
\fancyhf{}
\fancyhead[L]{\small\sffamily\color{black!60}AI 时代的可靠性架构}
\fancyhead[R]{\small\sffamily\color{black!60}v1.11.3}
